...
//
%fallback ID
  ABORT ACTION ADD AFTER AUTOINCREMENT BEFORE CASCADE CONFLICT DEFERRED ENGINE
  FAIL IGNORE INITIALLY INSTEAD NO PLAN QUERY KEY OFFSET RAISE REPLACE RESTRICT
  ENABLE DISABLE SHOW UUID.
%wildcard WILDCARD.
