...
box.execute('CREATE TABLE t0 (s1 VARCHAR(5) UNIQUE COLLATE "unicode_ci", id INT PRIMARY KEY AUTOINCREMENT);')
box.execute('CREATE TABLE t1 (s1 INT PRIMARY KEY, s0 VARCHAR(5) REFERENCES t0(s1) COLLATE "unicode_ci");')
...
box.execute('CREATE TABLE t3b (s1 VARCHAR(5) PRIMARY KEY collate "binary");')
...
box.execute('CREATE TABLE t3c (s1 VARCHAR(5) PRIMARY KEY collate "unicode");')
...
box.execute('CREATE TABLE t3d (s1 VARCHAR(5) PRIMARY KEY collate "binary");')
...
box.execute('CREATE TABLE t3e (s1 VARCHAR(5) PRIMARY KEY collate "unicode_ci");')
...
box.execute('CREATE TABLE t3f (s1 VARCHAR(5) PRIMARY KEY collate "unicode");')
...
box.execute('CREATE TABLE t3g (s1 VARCHAR(5) PRIMARY KEY collate "unicode_ci");')
