...
test:do_catchsql_test(
    ...
    [[
        ALTER TABLE t1 ADD CONSTRAINT ck CHECK(id > 0);
    ]], { 1, 'Duplicate key exists in unique index "name" in space "_func" '..
         'with old tuple - [66, 1, "check_T1_CK", 0, "SQL_EXPR", "id > 0", '..
         '"function", [], "any", "none", "none", true, false, true, ["LUA"], '..
         '{}, "", "", ""] and new tuple - [67, 1, "check_T1_CK", 0, '..
         '"SQL_EXPR", "id > 0", "function", [], "any", "none", "none", true, '..
         'false, true, ["LUA"], {}, "", "", ""]'})
