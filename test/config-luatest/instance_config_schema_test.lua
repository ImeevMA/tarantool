...
local function check_validate_iproto()
    ...
    local err = "[instance_config] iproto.advertise.peer.uri: Parameters " ..
                "for iproto.advertise.peer must be set " ..
                "via iproto.advertise.peer.params"
    t.assert_error_msg_equals(err, function()
        instance_config:validate(iconfig)
    end)
    ...
    err = "[instance_config] iproto.advertise.peer.uri: Login for " ..
          "iproto.advertise.peer must be set via iproto.advertise.peer.login"
    t.assert_error_msg_equals(err, function()
        instance_config:validate(iconfig)
    end)
    ...
    err = "[instance_config] iproto.advertise.peer: Params cannot be set " ..
          "witout setting uri"
    t.assert_error_msg_equals(err, function()
        instance_config:validate(iconfig)
    end)
    ...
    err = "[instance_config] iproto.advertise.sharding.uri: Parameters " ..
          "for iproto.advertise.sharding must be set " ..
          "via iproto.advertise.sharding.params"
    t.assert_error_msg_equals(err, function()
        instance_config:validate(iconfig)
    end)
    ...
    err = "[instance_config] iproto.advertise.sharding.uri: Login for " ..
          "iproto.advertise.sharding must be set " ..
          "via iproto.advertise.sharding.login"
    t.assert_error_msg_equals(err, function()
        instance_config:validate(iconfig)
    end)
    ...
    err = "[instance_config] iproto.advertise.sharding: Password cannot be " ..
          "set witout setting login"
    t.assert_error_msg_equals(err, function()
        instance_config:validate(iconfig)
    end)
...
for case_name, case in pairs({
    ...
    inet_socket_user = {
        listen = {{
            uri = 'user@localhost:3301',
        }},
    },
    inet_socket_user_pass = {
        listen = {{
            uri = 'user:pass@localhost:3301',
        }},
    },
    unix_socket = {
        listen = {{
    ...
    unix_socket_user = {
        listen = {{
            uri = 'user@unix/:/foo/bar.iproto',
        }},
    },
    unix_socket_user_pass = {
        listen = {{
            uri = 'user:pass@unix/:/foo/bar.iproto',
        }},
    },
    multiple_uris = {
        listen = {
    ...
    inaddr_any_ipv4_user = {
        listen = {{
            uri = 'user@0.0.0.0:3301',
        }},
    },
    inaddr_any_ipv4_user_pass = {
        listen = {{
            uri = 'user:pass@0.0.0.0:3301',
        }},
    },
    inaddr_any_ipv6 = {
        listen = {{
    ...
    zero_port_user = {
        listen = {{
            uri = 'user@localhost:0',
        }},
    },
    zero_port_user_pass = {
        listen = {{
            uri = 'user:pass@localhost:0',
        }},
    },
}) do
